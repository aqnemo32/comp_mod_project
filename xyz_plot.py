...
parser.add_argument(
    "--size", "-S", type=int, default=16, help="The size of each particle"
)

parser.add_argument(
    "--yz", action="store_true", help="Plot y vs z instead of x vs y"
)

parser.add_argument(
    "--xz", action="store_true", help="Plot x vs z instead of x vs y"
)
